<div id="filters">
    ...
    <button class="rounded-pill border-secondary px-3 py-1" wire:model="filter" wire:click="filter" name="order" value="asc">Alphabétique A - Z</button>
    <button class="rounded-pill border-secondary px-3 py-1" wire:model="filter" wire:click="filter" name="order" value="desc">Alphabétique Z - A</button>
