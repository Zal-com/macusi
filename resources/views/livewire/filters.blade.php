<div id="filters" class="my-4 text-center">
    <button class="rounded-pill border-secondary bg-white px-3 py-1 @if($filter === 'order_asc') bg-secondary text-white @endif" wire:click="order_asc" wire:model="order">Alphabétique A - Z</button>
    <button class="rounded-pill border-secondary bg-white px-3 py-1 @if($filter === 'order_desc') bg-secondary text-white @endif" wire:click="order_desc" wire:model="filter" name="order" value="desc">Alphabétique Z - A</button>
