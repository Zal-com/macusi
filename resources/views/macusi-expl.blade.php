...
@section('content')
        ...
        <p class="mb-28">Le <span class='MaCuSi'>MaCuSi</span> est une langue construite minimaliste aux niveaux phonologique et grammatical
            ...
            langue.</p>
        <p class="mb-28">Phonologiquement, le <span class='MaCuSi'>MaCuSi</span> utilise dix-sept consonnes (b, c, d, f, g, j, l, m, n, p, r, s, t, v, w,
        ...
        <p class="mb-28">Le principe du <span class='MaCuSi'>MaCuSi</span> est de n'avoir que 85 mots. Avec l'arrangement de ces 85 mots, il est
        ...
        <p class="mb-28">Du point de vue grammatical, le <span class='MaCuSi'>MaCuSi</span> veut garder que ce qui est essentiel et se caractérise
            par une absence de conjugaison, du genre des noms, de règles compliquées, d’exceptions,
            de particules...</p>
        <h3 class="h3-title mb-28">Avantages</h3>
        <p class="mb-28">Le premier, et non des moindres, avantage de cette langue est de ne devoir apprendre que
            les 85 mots de vocabulaire. Ce qui permet d’apprendre la langue en seulement deux jours.</p>
        <p class="mb-28">Le second avantage de cette langue est de garder l’alphabet latin moderne qui est connu par
        ...
        <p class="mb-28">Le troisième avantage est de pouvoir utiliser le <span class='MaCuSi'>MaCuSi</span> à partir de n’importe quelle langue
        ...
        <p class="mb-28">Chacun des 85 mots est composé d’une consonne écrite en majuscule suivit d’une voyelle
            écrite en minuscule. Exemple : Ba, Ce, Di, Fo, Gu…</p>
        <h3 class="h3-title mb-28">Phonologie</h3>
        <p class="mb-28">Il n’y a pas de contrainte réelle sur la manière de prononcer les sons. Bu peut se prononcer
