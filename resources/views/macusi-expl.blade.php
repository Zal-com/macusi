...
@section('content')
    <div class="container">
        ...
        <p>Le <span class='MaCuSi'>MaCuSi</span> est une langue construite minimaliste aux niveaux phonologique et grammatical
            ...
            langue.</p>
        <p>Phonologiquement, le <span class='MaCuSi'>MaCuSi</span> utilise dix-sept consonnes (b, c, d, f, g, j, l, m, n, p, r, s, t, v, w,
        ...
        <p>Le principe du <span class='MaCuSi'>MaCuSi</span> est de n'avoir que 85 mots. Avec l'arrangement de ces 85 mots, il est
        ...
        <p>Du point de vue grammatical, le <span class='MaCuSi'>MaCuSi</span> veut garder que ce qui est essentiel et se caractérise
            par une absence de conjugaison, du genre des noms, de règles compliquées, d’exceptions,
            de particules...</p>
        <h3>Avantages</h3>
        <p>Le premier, et non des moindres, avantage de cette langue est de ne devoir apprendre que
            les 85 mots de vocabulaire. Ce qui permet d’apprendre la langue en seulement deux jours.</p>
        <p>Le second avantage de cette langue est de garder l’alphabet latin moderne qui est connu par
        ...
        <p>Le troisième avantage est de pouvoir utiliser le <span class='MaCuSi'>MaCuSi</span> à partir de n’importe quelle langue
        ...
        <p>Chacun des 85 mots est composé d’une consonne écrite en majuscule suivit d’une voyelle
            écrite en minuscule. Exemple : Ba, Ce, Di, Fo, Gu…</p>
        <h3>Phonologie</h3>
        <p>Il n’y a pas de contrainte réelle sur la manière de prononcer les sons. Bu peut se prononcer
