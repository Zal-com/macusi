...
<div>
    <div class="container">
        <nav class="navbar side d-inline">
            ...
            <a class="nav-item table @if($url == 'password') active @endif" href="{{route('user.profile.password.edit', ['lang'=> app()->getLocale(), 'id' => Auth::id()])}}"><img class="icon" src="{{asset('storage/img/icon-lock.svg')}}"><span class="navbar-text">Modifier mot de passe</span></a>
