...
<div>
    ...
    <div class="container">
        <nav class="navbar side">
            <a class="nav-item table @if($url == 'index') active @endif" href=""><img class="icon" src="{{asset('storage/img/icon-user.svg')}}"><span class="navbar-text">Détails</span></a>
            ...
            <a class="nav-item table" href=""><img class="icon" src="{{asset('storage/img/icon-logout.svg')}}"><span class="navbar-text">Se déconnecter</span></a>
        </nav>
    </div>
</div>
