            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <p>
                            <a href="{{route('c-est-quoi')}}" class="text-reset">MaCuSi, c'est quoi ? </a>
                        </p>
                        <p>
                            <a href="{{ route('contruction') }}" class="text-reset">Construction de la langue</a>
                        </p>
                        <p>
                            <a href="{{route('dico.index')}}" class="text-reset">Dictionnaire</a>
                        </p>
                        <p>
                            <a href="{{route('register')}}" class="text-reset">Créer un compte</a>
                        </p>
                        <p>
                            <a href="{{route('login')}}" class="text-reset">Se connecter</a>
                        </p>
                    </div>
                    <!-- Grid column -->
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <a href="https://www.facebook.com/profile.php?id=100087166600089" class="me-4 text-reset">
